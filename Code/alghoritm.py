def start_process(input_text):
    ...
    # for key, value in top3_values.items():
    #     top3_final_values+=str(key) + ' : '+ '\n' + str(value) + '\n'
    # top3_values_file = open(r"F:\Eduard\Autodezvoltare\NLP camp\final version\NLPC-main\bot\Code\top3.txt", "wt")
    # random_top3 = top3_values_file.write(top3_final_values.encode('utf8').decode('utf8'))
    # top3_values_file.close()
    ...
    collected_strings = []  
    for string_text in tag.strings: 
        collected_strings.append(string_text)    
    ...
    random = text_file.write(string_text)
    text_file.close()
