def start_process(input_text):
    ...
    bow = joblib.load(r'F:\Eduard\Autodezvoltare\NLP camp\final version\NLPC-main\bot\World Map Visualization\bow.joblib')
    ...
    names = pd.read_csv(r'F:\Eduard\Autodezvoltare\NLP camp\final version\NLPC-main\bot\World Map Visualization\gender_refine-csv.csv')
    ...
    def Top_Comments(Dataframe, label = 'label', tweet = 'tweet'):
        ...
        cls = joblib.load(r'F:\Eduard\Autodezvoltare\NLP camp\final version\NLPC-main\bot\World Map Visualization\cls.joblib')
        gender = []
    ...
    submission['label'] = test_pred_int
    submission.to_csv(r'F:\Eduard\Autodezvoltare\NLP camp\final version\NLPC-main\bot\World Map Visualization\result.csv', index=False)
