...
plt.savefig(r'F:\Eduard\Autodezvoltare\NLP camp\final version\NLPC-main\bot\World Map Visualization\plot.png')
...
shapefile = r'F:\Eduard\Autodezvoltare\NLP camp\final version\NLPC-main\bot\World Map Visualization\110m_cultural\ne_110m_admin_0_countries.shp'
...
ax.set_title('World relative search interest of %s in 2021' %word_input, fontdict = {'fontsize':15})

ax.set_axis_off()

plt.savefig(r'F:\Eduard\Autodezvoltare\NLP camp\final version\NLPC-main\bot\World Map Visualization\trend_map.png')